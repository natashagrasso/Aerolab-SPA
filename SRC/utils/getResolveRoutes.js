...
const resolveRoutes = (route) => {
    ...
    if (route.length <= 3) { //si la ruta es igual a '/' (pag de inicio), entonces valideRoute se establece como '/' (la misma ruta). sino se establece como '/:id', es decor que se espera un ID en la ruta
